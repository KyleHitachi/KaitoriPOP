    ...
    <div className="rounded-[28px] border border-stone-200 bg-white p-5 shadow-[0_24px_80px_rgba(66,39,9,0.08)]">
      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
          <div className="mb-3 text-sm font-semibold text-stone-800">カード表示</div>
          <label className="flex items-start gap-3">
            ...
            <span>
              ...
              <span className="mt-1 block text-xs text-stone-500">
                デフォルトはオフです。必要なときだけカード下部に英名と日本語名を表示します。
              </span>
            </span>
          </label>
        </div>
        ...
        <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
          <div className="mb-3 text-sm font-semibold text-stone-800">ロゴ</div>
          <div className="grid grid-cols-2 gap-3">
            <label className="block text-xs font-medium text-stone-600">
              ...
              <input
                ...
                className="mt-2 block w-full text-xs file:mr-2 file:rounded-lg file:border-0 file:bg-white file:px-3 file:py-2 file:font-medium file:text-stone-700"
              />
            </label>
            <label className="block text-xs font-medium text-stone-600">
              MTG ロゴ
        ...
        <div className="rounded-2xl border border-stone-200 bg-stone-50 p-4">
          <div className="mb-3 text-sm font-semibold text-stone-800">行ラベル</div>
              ...
              return (
                <div key={row} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    placeholder="ラベルを入力"
                    className="flex-1 rounded-lg border border-stone-300 px-2 py-2 text-sm text-stone-800 outline-none transition focus:border-amber-500 focus:ring-2 focus:ring-amber-200"
                  />
